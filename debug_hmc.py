...
res = pricer.price_with_delta_cv(S0, payoff_fn, r, np.array(sigma_list), np.array(rho_mat), T, K, n_paths=50000, n_steps=30, seed=4)

print("Vanilla Price:", res["vanilla_price"])
print("CV Price:", res["cv_price"])
print("CV SE:", res["cv_se"])
print("Difference:", res["cv_price"] - res["vanilla_price"])
