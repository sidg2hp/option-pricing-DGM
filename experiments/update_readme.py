...
readme = re.sub(r'src="figures/fig2_dgm_vs_zhou\.png"', 'src="figures/neurips/fig2_4way_comparison.png"', readme)
...
readme = re.sub(r'src="figures/zhou_fig1_price_surface_2d\.png" width="450"', 'src="figures/neurips/fig3_price_comparison.png" width="800"', readme)
...
readme = re.sub(r'src="figures/fig1_scaling_error\.png"', 'src="figures/neurips/fig1_scaling_error.png"', readme)

# Update Ablation image
readme = re.sub(r'src="figures/fig4_ablation\.png"', 'src="figures/neurips/fig7_ablation.png"', readme)

# Update Hybrid MC image
readme = re.sub(r'src="figures/fig3_hybrid_mc\.png"', 'src="figures/neurips/fig6_hybrid_mc.png"', readme)
