...
res = cv.price_with_delta_cv(np.array([1.2]*3), mc_payoff, 0.05, np.array([0.2]*3), np.array([[1.0, 0.3, 0.3], [0.3, 1.0, 0.3], [0.3, 0.3, 1.0]]), 1.0, 1.0, n_paths=10000, n_steps=300, seed=4)
print(res)
